...
WebUI.navigateToUrl('https://www.time.com.my/')

WebUI.click(findTestObject('Object Repository/Page_Telco Solutions for Homes  Businesses _e454fb/div_For Home'))

WebUI.click(findTestObject('Object Repository/Page_Telco Solutions for Homes  Businesses _e454fb/div_For Home'))

WebUI.click(findTestObject('Object Repository/Page_Telco Solutions for Homes  Businesses _e454fb/div_Overview'))
...
WebUI.click(findTestObject('Object Repository/Page_Check Coverage  Time Internet/a_Application Status'))
